...
var ASM_CONSTS = {
  5108352: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 5108413: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 5108477: function() {return Module.webglContextAttributes.powerPreference;},  
 5108535: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 5108590: function($0) {performance.now = function() { return $0; };},  
 5108638: function($0) {performance.now = function() { return $0; };},  
 5108686: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  async function _Validate(url) {
      if (window.Telegram.WebApp) {
        // (async () => {
          ...
          const response = await fetch(`${l}validate/meow`, {
            body: initData,
            method: "POST",
            headers: {
